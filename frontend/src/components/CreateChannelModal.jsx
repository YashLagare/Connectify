...
const CreateChannelModal = ({ onClose }) => {
        ...
        const fetchUsers = async () => {
            ...
            try {
                const response = await client.queryUsers(
                    ...
                    { name: 1 }, //for sorting name based on the first letter like a, b, c, d, ....etc
                    { limit: 100 }
                );
    ...
    //to get real-time(during entering name it shows errors)issues
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            //assume user enter name like --> MY COOL CHANNEL !#1 => my-cool-channel-1(basically it convert in simple format)
        ...
        <div className="create-channel-modal-overlay">
            <div className="create-channel-modal">
                ...
                <form onSubmit={handleSubmit} className="create-channel-modal__form">
                    ...
                    {/* add members component this will render when user select channle type=> private to select members */}
                    {channelType === "private" && (
                        <div className="form-group">
